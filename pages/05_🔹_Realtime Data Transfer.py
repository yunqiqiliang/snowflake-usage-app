...
def main():
    ...
    while True:
        ...
        metric_0001.write(f"Metric 0001: {metric_0001_value}", f"+{metric_0001_delta}")
        ...
        metric_0002.write(f"Metric 0002: {metric_0002_value}", f"+{metric_0002_delta}")
        ...
        metric_0003.write(f"Metric 0003: {metric_0003_value}", f"+{metric_0003_delta}")
